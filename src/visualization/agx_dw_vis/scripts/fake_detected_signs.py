...
class DwFakeObjDetection:
    ...
    def init_topic_names_publisher(self):
        ...
        self.pub_fake_objects = rospy.Publisher("fake_obj", driveworks_msgs.DetectedObjectList, queue_size=0)
        self.pub_objects_distances = rospy.Publisher("/obj_distances", driveworks_msgs.EstimatedDistances, queue_size=0)
    ...
    def publish_fake_objects(self):
        pass
        #self.pub_fake_objects.publish(self.fake_objects_list)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            #print( len(self.fake_objects_list.data), "===========================", len(self.fake_distnces.data) )
            self.publish_fake_objects()
            r.sleep()
